...
from .views import RegisterView, LoginView,LogoutView,ProfileListView,PostCreateView,BlogPostListView,BlogPostDetailView,DeleteBlogPostView
...
urlpatterns = [
    ...
    # path('postsviews/<int:id>/update/', UpdatePostView.as_view(), name='post-update'),  
